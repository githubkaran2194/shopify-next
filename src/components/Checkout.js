        ...
        <div className="relative mx-auto w-full bg-white">
            ...
            <div className="grid min-h-screen grid-cols-10">
                <div className="col-span-full py-6 px-4 sm:py-12 lg:col-span-6 lg:py-24">
                    ...
                    <ol role='list' className='flex items-center'>
                        <li className="text-left">
                            <div className="-m-1">
                                <Link href="/products" className="rounded-md p-1 text-sm font-medium text-gray-600 focus:text-gray-900 focus:shadow hover:text-gray-800"> Products </Link>
                            </div>
                        </li>
                        <span className='mx-2 text-gray-300'> / </span>
                        <li className="text-left">
                        <div className="-m-1">
                            <Link href="/cart" className="rounded-md p-1 text-sm font-medium text-gray-600 focus:text-gray-900 focus:shadow hover:text-gray-800"> Cart </Link>
                        </div>
                    </li>
                    </ol>
                </nav>
                        ...
                        <form className="mt-10 flex flex-col space-y-4">
                            ...
                            <div className="relative">
                                ...
                                <input type="text" id="card-number" name="card-number" placeholder="1234-5678-XXXX-XXXX" className="block w-full rounded border-gray-300 bg-gray-50 py-3 px-4 pr-10 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500" />
                            ...
                            <div>
                                ...
                                <div className="mr-6 flex flex-wrap">
                                    ...
                                    <div className="relative my-1">
                                        ...
                                        <input type="text" id="security-code" name="security-code" placeholder="Security code" className="block w-36 rounded border-gray-300 bg-gray-50 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500" />
                                    </div>
                                </div>
                            </div>
                            <div>
                                <label htmlFor="card-name" className="sr-only">Card name</label>
                                <input type="text" id="card-name" name="card-name" placeholder="Name on the card" className="mt-1 block w-full rounded border-gray-300 bg-gray-50 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-teal-500" />
                            </div>
                        </form>
                        <p className="mt-10 text-center text-sm font-semibold text-gray-500">
                            By placing this order you agree to the <Link href="#" className="whitespace-nowrap text-teal-400 underline hover:text-teal-600">Terms and Conditions</Link>
                        </p>
                ...
                <div className="relative col-span-full flex flex-col py-6 pl-8 pr-4 sm:py-12 lg:col-span-4 lg:py-24">
                    ...
                    <div>
                        <img src="https://images.unsplash.com/photo-1599751449128-eb7249c3d6b1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80" alt="" className="absolute inset-0 h-full w-full object-cover" />
                                ...
                                <li className="flex justify-between" key={item.id}>
                                    <div className="inline-flex">
                                        ...
                                        <div className="ml-3">
                                            ...
                                            <p className="text-sm font-semibold text-white">Quantity: {item.quantity}</p>
                                        </div>
                                    </div>

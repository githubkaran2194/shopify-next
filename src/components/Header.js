        ...
        <header className="bg-white py-4">
            <div className="mx-auto max-w-screen-xl flex justify-between items-center px-4 sm:px-20 xl:px-10">
                <div className="flex items-center">
                    <img src="https://images.unsplash.com/photo-1599751449128-eb7249c3d6b1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80" alt="Boleno Logo" className="h-10 w-10 mr-2" />
                    <Link href="/" className="text-gray-600 text-2xl font-bold hover:text-blue-600">shopify</Link>
                </div>

...
export default function ProductDetailAll({ details }) {
            ...
            <div className="container mx-auto px-4">
                    ...
                    <ol role="list" className="flex items-center">
                        ...
                        <li className="text-left">
                            <div className="flex items-center">
                                <span className="mx-2 text-gray-400">/</span>
                                <div className="-m-1">
                                    <Link href="#" className="rounded-md p-1 text-sm font-medium text-gray-600 focus:text-gray-900 focus:shadow hover:text-gray-800" aria-current="page"> {details.title} </Link>
                                </div>
                            </div>
                        </li>
                    </ol>
                ...
                <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
                        ...
                        <div className="lg:flex lg:items-start">
                            <div className="lg:order-2 lg:ml-5">
                                <div className="max-w-xl overflow-hidden rounded-lg">
                                    <img className="h-full w-full max-w-full object-cover" src={details.images[currentIndex]} alt="" />
                                </div>
                            </div>
                                ...
                                <div className="flex flex-row items-start lg:flex-col">
                                    {details.images.map((img, index) => (
                                        <button
                                            key={index}
                                            type="button"
                                            className={`flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 ${currentIndex === index ? 'border-gray-900' : 'border-transparent'} text-center`}
                    ...
                    <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                        <h1 className="sm: text-2xl font-bold text-gray-900 sm:text-3xl">{details.title}</h1>
                        ...
                        <div className="mt-10 flex flex-col items-center justify-between gap-3 space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
                            <div className="flex items-end">
                                <h1 className="text-3xl font-bold">$ {details.price}</h1>
                                <span className="text-base">/month</span>
                            </div>
                            </div>
                            <AddToCartBtn product={details}/>
                    ...
                    <div className="lg:col-span-3">
                        <div className="border-b border-gray-300">
                            <nav className="flex gap-4">
                                <Link href="#" title="" className="border-b-2 border-gray-900 py-4 text-sm font-medium text-gray-900 hover:border-gray-400 hover:text-gray-800"> Description </Link>
                                <Link href="#" title="" className="inline-flex items-center border-b-2 border-transparent py-4 text-sm font-medium text-gray-600">
                                    Reviews
